...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MarkOrderPaid = channel.unary_unary(
                '/order.OrderService/MarkOrderPaid',
                request_serializer=order__pb2.MarkOrderPaidRequest.SerializeToString,
                response_deserializer=order__pb2.MarkOrderPaidResponse.FromString,
                _registered_method=True)
        self.ShipOrder = channel.unary_unary(
                '/order.OrderService/ShipOrder',
                request_serializer=order__pb2.ShipOrderRequest.SerializeToString,
                response_deserializer=order__pb2.ShipOrderResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'MarkOrderPaid': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.MarkOrderPaidRequest.FromString,
                    response_serializer=order__pb2.MarkOrderPaidResponse.SerializeToString,
            ),
            'ShipOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.ShipOrder,
                    request_deserializer=order__pb2.ShipOrderRequest.FromString,
                    response_serializer=order__pb2.ShipOrderResponse.SerializeToString,
            ),
...
class OrderService(object):
    ...
    def MarkOrderPaid(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/MarkOrderPaid',
            order__pb2.MarkOrderPaidRequest.SerializeToString,
            order__pb2.MarkOrderPaidResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ShipOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/ShipOrder',
            order__pb2.ShipOrderRequest.SerializeToString,
            order__pb2.ShipOrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
